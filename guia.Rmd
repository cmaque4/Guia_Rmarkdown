...
xaringanExtra::style_panelset_tabs(#background = "#DB3A34",
                                   font_family = "Cambria",
                                   inactive_opacity = 1,
                                   tabs_border_bottom	= "#FFC857",
                                   hover_foreground = "#87FF65",
                                   active_foreground = "#FFC857",
                                   foreground = "#FFC857"
)
```
...
<div class="alert alert-block" style="background-color:#093A3E">
<b> &#x1F4CC; Tip: this is how. </b></div>

<div class="alert alert-block" style="background-color:#B27092">
<b> Lorem tristique montes sem cursus laoreet metus! Facilisis ullamcorper donec potenti torquent nam quisque lectus vel facilisis. Montes ante mus curae lacinia.
...
Consectetur tincidunt eu sem cursus ullamcorper ullamcorper condimentum cum porttitor. Ligula gravida ligula augue vel suscipit odio mi? Natoque tincidunt nibh etiam est scelerisque himenaeos quis posuere conubia. </b></div>

```{r}
tweetrmd::tweet_embed("https://twitter.com/Luciimbiriba/status/1495866712041918465")
```

```{r}
tweetrmd::tweet_embed("https://twitter.com/shwanpai/status/1479951046025830401")
```
...
## Sideways Panels {.panelset .sideways #sideways-panels}
...
## Right Sideways Panels {.panelset .sideways .right}
